#!/usr/bin/env node
/**
 * Build SpoofDPI 1.2.1 (docspi-proxy) and copy to spoofdpi/ and src-tauri/binaries/.
 * Requires Go in PATH.
 */
...
const outExe = path.join(root, 'spoofdpi', 'docspi-proxy.exe');
...
console.log('Building SpoofDPI (docspi-proxy) with release flags...');
